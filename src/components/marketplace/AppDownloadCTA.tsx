...
const AppDownloadCTA = ({
    ...
    return (
      <div className="fixed bottom-0 left-0 right-0 z-50 p-3 bg-background/95 backdrop-blur-md border-t border-white/10 lg:hidden">
        <div className="flex items-center gap-3 max-w-lg mx-auto">
          ...
          <button className="bg-primary text-primary-foreground text-sm font-semibold px-4 py-2 rounded-full whitespace-nowrap">
            Get App
          </button>
        </div>
      </div>
    ...
    return (
      <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 text-center space-y-4">
        ...
        <div className="flex items-center justify-center gap-3">
          <div className="flex items-center gap-2 bg-card border border-border rounded-xl px-4 py-2.5 cursor-pointer hover:bg-card/80 transition-colors">
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary/10 border border-primary/20">
      ...
      <button className="bg-primary text-primary-foreground text-xs font-semibold px-3 py-1.5 rounded-full whitespace-nowrap">
        Get App
      </button>
    </div>
  );
